...
static inline void hwme_in_r_addr_set(unsigned int value) {
  HWME_WRITE(value, HWME_IN_R_ADDR);
}

static inline void hwme_in_i_addr_set(unsigned int value) {
  HWME_WRITE(value, HWME_IN_I_ADDR);
}

static inline void hwme_out_r_addr_set(unsigned int value) {
  HWME_WRITE(value, HWME_OUT_R_ADDR);
}

static inline void hwme_out_i_addr_set(unsigned int value) {
  HWME_WRITE(value, HWME_OUT_I_ADDR);
}

static inline void hwme_a10_r_data_set(unsigned int value) {
  HWME_WRITE(value, HWME_A10_R_ADDR);
}

static inline void hwme_a10_i_data_set(unsigned int value) {
  HWME_WRITE(value, HWME_A10_I_ADDR);
}

static inline void hwme_a30_r_data_set(unsigned int value) {
  HWME_WRITE(value, HWME_A30_R_ADDR);
}

static inline void hwme_a30_i_data_set(unsigned int value) {
  HWME_WRITE(value, HWME_A30_I_ADDR);
}

static inline void hwme_a50_r_data_set(unsigned int value) {
  HWME_WRITE(value, HWME_A50_R_ADDR);
}

static inline void hwme_a50_i_data_set(unsigned int value) {
  HWME_WRITE(value, HWME_A50_I_ADDR);
}
